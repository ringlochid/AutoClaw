...
list_suite() {
  ...
  case "$suite" in
    integration-local|integration-db)
      ...
      describe_group "phase2" apps/api/tests/integration/phase2
      describe_group \
        "phase3-routes-control" \
        apps/api/tests/integration/phase3/routes \
        apps/api/tests/integration/phase3/control
      describe_group "phase3-db" apps/api/tests/integration/phase3/db
      describe_group "phase3-contracts" apps/api/tests/integration/phase3/contracts
      describe_group "phase4a" apps/api/tests/integration/phase4a
      describe_group "phase4b-mcp" apps/api/tests/integration/phase4b/mcp
      describe_group "phase4b-watchdog" apps/api/tests/integration/phase4b/watchdog
      describe_group "phase5a" apps/api/tests/integration/phase5a
      ;;
    e2e-minimal)
      describe_group "e2e-minimal" apps/api/tests/e2e/phase2/test_minimal_runtime_lane.py
      ;;
    e2e-normal)
      describe_group "e2e-normal" apps/api/tests/e2e/phase3/normal_lane/test_normal_lane.py
      ;;
    e2e-maximal)
      describe_group "e2e-maximal" apps/api/tests/e2e/phase4/maximal_lane/test_maximal_lane.py
      ;;
    e2e-all)
...
run_e2e_suite() {
  ...
  case "$suite" in
    e2e-minimal)
      run_group "e2e-minimal" apps/api/tests/e2e/phase2/test_minimal_runtime_lane.py
      ;;
    e2e-normal)
      run_group "e2e-normal" apps/api/tests/e2e/phase3/normal_lane/test_normal_lane.py
      ;;
    e2e-maximal)
      run_group "e2e-maximal" apps/api/tests/e2e/phase4/maximal_lane/test_maximal_lane.py
      ;;
    e2e-all)
