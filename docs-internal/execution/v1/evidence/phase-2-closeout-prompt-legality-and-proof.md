...
- `./.venv/bin/ruff check scripts/docs`
  - result: `All checks passed!`
- `./.venv/bin/mypy apps/api/src/autoclaw/runtime/prompt apps/api/src/autoclaw/runtime/projection apps/api/src/autoclaw/runtime/task_root apps/api/src/autoclaw/runtime/launch apps/api/tests/unit/runtime_prompt_rendering apps/api/tests/integration/phase2/bootstrap scripts/docs/prompt_catalog`
