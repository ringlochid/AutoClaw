...
- docs validators: `scripts.docs.docs_freeze.cli` passed after the Phase 6 packet rewrite and stale partial-packet removal
...
| transport owners | API, CLI, legacy `cli_commands/**`, legacy `terminal/**`, and public wrapper families still encode parallel durable owners |
