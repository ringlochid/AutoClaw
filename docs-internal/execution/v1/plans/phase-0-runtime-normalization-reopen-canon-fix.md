...
1. Create the new summary-only master triplet under `docs-internal/archive/execution/*/phase-0-to-4.5-runtime-normalization-reopen-program`.
...
- stop if a truthful repair requires touching `docs-internal/design/v1/**`
- stop if a truthful repair requires creating a fresh authoritative Phase 3, Phase 4A, Phase 4B, or Phase 4.5 triplet now

## Cross-links

- summary-only master plan: `../../../archive/execution/plans/phase-0-to-4.5-runtime-normalization-reopen-program.md`
- matching authoritative evidence: `../evidence/phase-0-runtime-normalization-reopen-canon-fix.md`
- matching authoritative review: `../reviews/phase-0-runtime-normalization-reopen-canon-fix.md`
