...
- historical execution-review artifacts under `docs-internal/archive/execution/reviews/` when broken `## Authoritative replacements` links must be repaired to truthful live targets
