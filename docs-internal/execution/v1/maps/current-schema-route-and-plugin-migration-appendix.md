...
It is implementation guidance only. If this appendix and `docs-internal/design/v1/` disagree, `docs-internal/design/v1/` wins.
...
- do not keep current generic mutation helpers alive as if they were part of the frozen design
