...
- [ ] I checked any required supporting design reads explicitly named by the current phase page when live target semantics, decisions, onboarding, recovery, or tutorial coverage mattered
...
- [ ] I checked `docs-internal/current/v1/` second if migration truth or current behavior mattered
...
- [ ] I used `docs-internal/archive/` or older source packs only because canonical docs were still silent
