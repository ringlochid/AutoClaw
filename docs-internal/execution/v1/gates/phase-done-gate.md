...
Use this gate for every design phase.
...
- [ ] primary design contract pages for the phase were updated when needed
- [ ] required supporting design reads named by the phase page were used when live target semantics, durable decisions, onboarding, recovery, or tutorial coverage mattered
...
- [ ] mandatory review outputs and explicit exceptions are recorded under `docs-internal/execution/v1/reviews/`
