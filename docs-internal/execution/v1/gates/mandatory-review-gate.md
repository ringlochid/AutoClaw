...
Every design phase must pass this review before it can be marked done.

- [ ] landed code matches the phase contract and does not drift from canonical design docs
- [ ] landed work matches the approved phase plan deliverables and work packages
- [ ] the approved phase plan is recorded under `docs-internal/execution/v1/plans/`
...
- [ ] required supporting design reads named by the phase page were reread when live target semantics, durable decisions, onboarding, recovery, or tutorial coverage mattered
...
- [ ] executed validator, test, gate, reset, and smoke proof is recorded under `docs-internal/execution/v1/evidence/`
- [ ] mandatory review outputs and any explicit exceptions are recorded under `docs-internal/execution/v1/reviews/`
