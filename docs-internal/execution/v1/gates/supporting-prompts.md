...
```text
Build the WBS for the current design phase.
...
- name the required supporting design reads, required current-contrast reads, and required examples and diagrams per work package
...
```text
Set up test-first work for the current design work package.
