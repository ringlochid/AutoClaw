...
- [ ] design implementation is explicitly using a fresh-baseline schema reset
- [ ] current design-incompatible target-facing tables/models are marked for deletion
