...
This phase succeeds only if it TOTALLY resets the code before design implementation continues into Phase 1.
...
- [Plugin tool reference](../../../design/v1/interfaces/plugin-tool-reference.md)
...
- [Durable decisions](../../../adr/README.md) when reset scope, stale-vocabulary deletion, or survivor authority is disputed
- [Watchdog and provider recovery](../../../design/v1/architecture/watchdog-and-provider-recovery.md) when plugin or transport survivors are being classified for deletion
- [Historical prompt and artifact layers](../../../design/v1/prompt-layer/historical-prompt-and-artifact-layers.md), [historical dispatch-family packs](../../../design/v1/prompt-layer/prompt-pack/dispatch-family-packs.md), [historical packet prose examples](../../../design/v1/prompt-layer/prompt-pack/historical-packet-prose-examples.md), and [historical state and boundary overlays](../../../design/v1/prompt-layer/prompt-pack/state-and-boundary-overlays.md) when reset classification must prove that prompt, packet, bundle, or overlay survivors are stale-only
- [Findings](../../../archive/design/findings.md) only when owner docs plus accepted ADRs still do not settle whether a survivor is target-compatible
...
- design owner pages unless cleanup canon is genuinely incomplete
...
- keep and rerun design-agnostic infra tests for config, package entrypoints, install, and health where still applicable
...
- Phase 0.5 must not leave any carried migration history, packaged migration mirror, or reset-only schema table acting as design authority

## Kill-list terms

- compatibility-minded migration of design-incompatible target schema
