...
- [How-to guides](../../../design/v1/how-to/README.md)
- [Install and onboard](../../../design/v1/how-to/install-and-onboard.md)
- [Publish a release](../../../design/v1/how-to/publish-a-release.md)
- [Tutorials](../../../design/v1/tutorials/README.md)
- [Onboard locally](../../../design/v1/tutorials/onboard-locally.md)
- [End-to-end design walkthrough](../../../design/v1/tutorials/end-to-end-design-walkthrough.md)
...
- [API schema appendix](../../../design/v1/interfaces/api-schema-appendix.md) when package or reset behavior changes public examples

## Implementation surfaces

- owned surfaces: `pyproject.toml`, `Makefile`, `scripts/*`, install/release/onboarding docs, root/router docs that must point to the final canonical surfaces, and archive cleanup under `docs-internal/archive/*`
...
- owned surfaces: `docs-internal/archive/*` and stale canonical-doc references
