...
| `v2-definition-authoring-api`      | flat draft route envelopes, YAML-body save, normalized JSON shadow or baseline generation, validate/publish, and collision or stale protection over registry truth | role/policy schema                                                                                          | registry truth model, runtime dispatch truth                       |
