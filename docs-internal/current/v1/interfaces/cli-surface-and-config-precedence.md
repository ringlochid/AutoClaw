...
Current parser truth still excludes some target-design interaction behaviors even though the flags now parse:
...
For the clean-break target CLI groups and operator workflows, see `../../../design/v1/interfaces/cli-surface-and-operator-workflows.md` and `../../../design/v1/interfaces/api-surface-and-trust-lane-map.md`.
