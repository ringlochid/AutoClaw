...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("openclaw", "local", "remote", name="skill_provider", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "scope",
            sa.Enum("task", "shared", name="resource_scope", native_enum=False),
            nullable=False,
        ),
        sa.Column("key", sa.String(length=128), nullable=False),
        sa.Column("title", sa.String(length=256), nullable=False),
        ...
        sa.Column(
            "kind",
            sa.Enum(
                "repo", "docs", "mixed", "generated", name="workspace_root_kind", native_enum=False
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "published",
                "archived",
                name="definition_version_status",
                native_enum=False,
            ),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["policy_definition_id"], ["policy_definitions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["role_definition_id"], ["role_definitions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        "ix_skill_versions_registry_status", "skill_versions", ["skill_registry_id", "status"]
    )
    ...
    op.create_index(
        "ix_task_resource_bindings_task_role", "task_resource_bindings", ["task_id", "binding_role"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "edge_kind",
            sa.Enum("control", "dependency", name="flow_edge_kind", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_flow_nodes_flow_logical_node", "flow_nodes", ["flow_id", "logical_node_key"]
    )
    ...
    op.create_index(
        "ix_node_attempts_flow_node_number", "node_attempts", ["flow_id", "flow_node_id", "number"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("idle", "active", "ended", name="node_session_status", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_node_checkpoints_flow_attempt", "node_checkpoints", ["flow_id", "node_attempt_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "adopted",
                "superseded",
                name="node_plan_revision_status",
                native_enum=False,
            ),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["base_flow_revision_id"], ["flow_revisions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["candidate_flow_revision_id"], ["flow_revisions.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_node_plan_revisions_flow_status", "node_plan_revisions", ["flow_id", "status"]
    )
