...
from autoclaw.db.models import AssignmentModel, AttemptModel, DispatchTurnModel, FlowNodeModel
from autoclaw.runtime.control.assignment.persistence import (
...
from autoclaw.runtime.control.assignment.staging import (
    load_superseded_child_assignment,
    resolve_assign_child_dependency_refs,
)
from autoclaw.runtime.control.budgets import consume_assignment_budget
...
from autoclaw.runtime.control.flow.queries import flow_node_by_key, next_node_sequence_number
from autoclaw.runtime.control.flow.service import runtime_flow_read
from autoclaw.runtime.control.release.guards import ensure_no_staged_child_assignment
from autoclaw.runtime.effects.cases import stage_assign_child_outputs
from autoclaw.runtime.effects.writes import DeferredRuntimeWrite
from autoclaw.runtime.ids import assignment_id, assignment_key_for_task, attempt_id_for_task
...
from autoclaw.schemas.runtime import AssignChildSuccess, AssignmentFileRef, WorkflowManifestRef
from autoclaw.schemas.runtime.contracts import EvidenceRef, NodeRuntimeFileRef, TaskRootPaths
from autoclaw.schemas.runtime.parent_tools import AssignChildToolCall
