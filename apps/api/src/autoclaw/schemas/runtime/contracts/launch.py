...
from autoclaw.compiler.contracts import NormalizedCompiledPlan
from autoclaw.compiler.role_policy_lookup import MappingRolePolicyLookup
from autoclaw.schemas.definitions.workflow import WorkflowDefinitionInput
from autoclaw.schemas.runtime.contracts.primitives import (
    RuntimeText,
    TaskComposeInput,
    TaskIdentifier,
    TaskRootPaths,
)
from autoclaw.schemas.runtime.contracts.projection import (
    AssignmentProjection,
    CheckpointProjection,
    ManifestProjection,
    StructuralEditPaletteProjection,
)
from autoclaw.schemas.runtime.contracts.prompt import PersistedPromptRecord, RenderedPromptBundle
