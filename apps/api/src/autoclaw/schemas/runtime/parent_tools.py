...
from autoclaw.schemas.runtime.checkpoint import TransientSurfaceWrite
...
from autoclaw.schemas.runtime.refs import AssignmentFileRef, CheckpointFileRef, WorkflowManifestRef
