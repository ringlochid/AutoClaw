...
from autoclaw.compiler.contracts import NormalizedCompiledPlan, WorkflowRevisionMetadata
from autoclaw.compiler.normalize import (
...
from autoclaw.compiler.role_policy_lookup import RolePolicyLookup
