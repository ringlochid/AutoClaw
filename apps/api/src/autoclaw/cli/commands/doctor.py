...
from autoclaw.cli.commands.service import DEFAULT_SERVICE_NAME, collect_service_status
from autoclaw.cli.support import coerce_path, command_env, print_json
from autoclaw.cli.terminal.theme import heading, muted, rich_enabled, success, warn
from autoclaw.config import load_settings
from autoclaw.db.session import ping_database, verify_database_schema
...
async def _collect_local_doctor_findings(
    ...
    with resources.as_file(packaged_seed_definitions_root) as definitions_root:
        findings.append(
            {
