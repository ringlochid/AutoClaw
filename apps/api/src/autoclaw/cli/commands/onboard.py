...
from autoclaw.cli.commands.server_config import (
    build_server_bind_check_payload,
    emit_server_bind_check_failure,
    update_server_config_overrides,
)
from autoclaw.cli.commands.service import DEFAULT_SERVICE_NAME, cmd_service_install
from autoclaw.cli.support import coerce_path, command_env, print_json
from autoclaw.cli.terminal.note import note
from autoclaw.cli.terminal.prompts import PromptUnavailableError, confirm, text
from autoclaw.cli.terminal.theme import accent, heading, muted, rich_enabled, success, warn
from autoclaw.config import DEFAULT_API_PORT, load_settings
from autoclaw.paths import ensure_runtime_dirs
from autoclaw.runtime.openclaw.host_setup import host_base_url_from_config
