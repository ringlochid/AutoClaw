...
from autoclaw.db.session import (
    dispose_db_engine,
    ensure_database_schema,
    get_session_factory,
    ping_database,
)
from autoclaw.registry import seed_definition_registry
...
def _required_schema_columns() -> dict[str, set[str]]:
    from autoclaw.db import RuntimeBase
...
async def _repair_postgres_legacy_schema(database_url: str) -> DatabaseRepairResult:
    from autoclaw.db import RuntimeBase
    from autoclaw.db.session import get_async_engine
