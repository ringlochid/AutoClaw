...
if TYPE_CHECKING:
    from app.db.models.runtime.assignment_execution import AssignmentModel, AttemptModel
    ...
    from app.db.models.runtime.dispatch_support import NodeSessionModel
