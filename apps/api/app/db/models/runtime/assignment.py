...
class AttemptModel(RuntimeBase):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            f"terminal_outcome IN ({_sql_in(CHECKPOINT_OUTCOME_VALUES)})",
...
class AttemptCheckpointModel(RuntimeBase):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            f"checkpoint_kind IN ({_sql_in(CHECKPOINT_KIND_VALUES)})",
...
class AttemptConsumedRefModel(RuntimeBase):
    ...
    __table_args__ = (
        CheckConstraint(
            f"ref_kind IN ({_sql_in(RUNTIME_REF_KIND_VALUES)})",
