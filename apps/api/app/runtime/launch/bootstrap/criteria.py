...
from app.compiler import NormalizedCompiledNode
from app.db.models import AssignmentCriteriaRefModel, AssignmentModel
from app.runtime.contracts import TaskRootPaths
from app.runtime.ids import assignment_criteria_ref_id
