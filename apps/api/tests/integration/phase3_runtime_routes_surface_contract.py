...
from tests.integration.phase3_runtime_routes_observability_support import (
...
async def test_phase3_runtime_routes_return_before_manifest_effect_drain(
    ...
    import app.runtime.post_commit as post_commit
    ...
    async with phase3_route_context(tmp_path) as context:
        ...
        execute_effect = post_commit.execute_runtime_effect
        ...
        monkeypatch.setattr(post_commit, "execute_runtime_effect", block_manifest_effect)
