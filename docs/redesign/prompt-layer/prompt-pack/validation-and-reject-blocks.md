...
- `docs/redesign/interfaces/api-schema-appendix.md` is the API/status carrier reference for `operation_failure`. It does not replace the runtime legality rules or the prompt-layer message substance.
