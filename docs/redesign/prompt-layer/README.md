...
- structural edits may use only role/policy names from the surfaced compact `structural_edit_palette` in current prompt or manifest context, and runtime revalidates committed names on commit
