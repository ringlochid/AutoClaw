...
- use only role/policy names from the surfaced compact `structural_edit_palette` in current prompt or manifest context for structural edits; runtime still revalidates committed names on commit
