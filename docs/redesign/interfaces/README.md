...
1. [INDEX.md](INDEX.md)
2. [mcp-plugin-and-cli-boundary.md](mcp-plugin-and-cli-boundary.md)
3. [api-surface-and-trust-lane-map.md](api-surface-and-trust-lane-map.md)
4. [api-schema-appendix.md](api-schema-appendix.md)
5. [api-machine-catalog.yaml](api-machine-catalog.yaml)
6. [definition-registry-and-upload-contract.md](definition-registry-and-upload-contract.md)
7. [role-and-policy-definition-schema.md](role-and-policy-definition-schema.md)
8. [plugin-tool-reference.md](plugin-tool-reference.md)
