...
5. the controller writes checkpoint rows and advances `attempts.latest_checkpoint_id`
6. the runtime regenerates `_runtime/attempts/<attempt_id>/latest-checkpoint.*`
