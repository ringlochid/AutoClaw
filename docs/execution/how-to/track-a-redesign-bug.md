# Track a redesign bug

Status: Target

This page defines the canonical bug-tracking template and workflow for redesign implementation failures.
...
5. Link the bug to the canonical redesign page that should define the behavior.
