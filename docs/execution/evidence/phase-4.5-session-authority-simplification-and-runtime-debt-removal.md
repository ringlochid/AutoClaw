...
This artifact is a summary-only historical Phase 4.5 closeout evidence record.
It records the earlier closed Phase 4.5 proof only and must not be used as
live Phase 4.5 closure evidence after the runtime-normalization reopen
canon-fix triplet landed.
