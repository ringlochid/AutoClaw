...
- the Phase 4.5 owned and allowed-collateral surfaces named on the selected phase page and in `docs/execution/maps/file-priority-map.md`
- the bridge-facing current contrast page `docs/current/architecture/openclaw-and-bridge-plugin.md`
...
- summary-only runtime-normalization program router: [phase-0-to-4.5-runtime-normalization-reopen-program](phase-0-to-4.5-runtime-normalization-reopen-program.md)
- historical summary-only Phase 4.5 plan: [phase-4.5-session-authority-simplification-and-runtime-debt-removal](phase-4.5-session-authority-simplification-and-runtime-debt-removal.md)
