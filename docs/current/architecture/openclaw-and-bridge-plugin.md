...
- the target redesign still wants a cleaner provider, worker, and operator split plus cleaner gateway control surfaces than the current tree exposes locally
