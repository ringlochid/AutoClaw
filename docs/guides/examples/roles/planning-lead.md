...
- it classifies ambiguity before choosing a route
- it delegates heavy work, challenges weak evidence, and uses explicit control tools during an open dispatch
