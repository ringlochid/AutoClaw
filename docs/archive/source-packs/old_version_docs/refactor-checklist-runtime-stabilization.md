...
- [x] `../../../roadmap/current.md` was updated with the actual current verification baseline.
- [x] `../../../flows/02-default-runtime-lifecycle.md` now matches current controller advancement behavior.
- [x] `../../../flows/04-approval-and-watchdog.md` now matches current approval auto-advance and watchdog semantics.
- [x] `../../../api-route-trust-lanes.md` carries a current “last verified” contract.
- [x] `../../../registry-definition-precedence.md` carries a current “last verified” contract.
...
- [x] The authoritative active worklist is now `../../../roadmap/next.md`.
