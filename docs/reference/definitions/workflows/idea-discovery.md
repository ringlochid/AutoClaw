...
root:
    ...
    instruction: >-
      Route research, option shaping, critique, and recommendation work as separate
      evidence steps. Do not let discovery drift into build work.
    criteria:
    ...
    children:
        - id: gather_context
          ...
          instruction: >-
            Publish only evidence that changes option selection, feasibility, or
            next-step direction.
          produces:
              artifacts:
        ...
        - id: shape_options
          ...
          instruction: >-
            Compare options by user value, feasibility, risk, scope, and confidence. Do
            not choose by taste alone.
          consumes:
              artifacts:
                  - slot: discovery_context
          produces:
        ...
        - id: critique_options
          ...
          instruction: >-
            Identify overreach, missing proof, hidden dependencies, and contradictions
        ...
        - id: recommend_direction
          ...
          instruction: >-
            Publish the recommendation, rationale, rejected alternatives, and safest
            next workflow shape.
          consumes:
              artifacts:
                  - slot: discovery_context
