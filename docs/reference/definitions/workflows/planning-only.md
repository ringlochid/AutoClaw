...
root:
    ...
    instruction: >-
      Keep the workflow in planning mode. Route implementation requests to a later
      workflow instead of silently doing them here.
    criteria:
    ...
    children:
        - id: define_scope
          ...
          instruction: >-
            Separate must-have scope, follow-up scope, out-of-scope work, and open
            product decisions.
          produces:
              artifacts:
                  - slot: scope_brief
        ...
        - id: map_work
          ...
          instruction: >-
            Keep work packages bounded and ready for later assignment. Do not implement
            them.
          consumes:
              artifacts:
                  - slot: scope_brief
        ...
        - id: publish_final_plan
          ...
          instruction: >-
            Resolve review feedback where possible and clearly name remaining decisions
            or blockers.
          consumes:
              artifacts:
                  - slot: scope_brief
